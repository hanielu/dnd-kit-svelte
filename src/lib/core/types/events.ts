import type {PointerActivationConstraint} from '../sensors/index.js';
import type {Active, Over} from '../store/index.js';
import type {Collision} from '../utilities/algorithms/index.js';

import type {Coordinates, Translate} from './coordinates.js';
import type {UniqueIdentifier} from './index.js';
