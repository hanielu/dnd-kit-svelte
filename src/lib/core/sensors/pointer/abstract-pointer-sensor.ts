import {subtract as getCoordinatesDelta, getEventCoordinates, getOwnerDocument, getWindow} from '$utilities';
...
import type {SensorInstance, SensorProps, SensorOptions} from '../types.js';
import type {Coordinates, DistanceMeasurement} from '../../types/index.js';
...
export type PointerActivationConstraint = DelayConstraint | DistanceConstraint | (DelayConstraint & DistanceConstraint);
...
export class AbstractPointerSensor implements SensorInstance {
	...
	private handlePending(constraint: PointerActivationConstraint, offset?: Coordinates | undefined): void {
